...
const Product = ({ id, name, price, image, metal, size }) => {
    ...
    <Link to={`/product/${id}`}>
      <div className="product bg-[#383532] bg-opacity-25 flex flex-col items-center relative w-[300px] h-[180px] rounded-xl my-16 hover:enlarge">
        <img
          ...
          alt={name}
          width={200}
          className="absolute -top-[90px] transition-transform duration-300 ease-in-out transform hover:scale-110 cursor-pointer"
        />
